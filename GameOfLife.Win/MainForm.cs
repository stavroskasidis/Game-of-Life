...
namespace GameOfLife
{
    public partial class MainForm : Form
    {
        ...
        private IGenerationSetter _generationSetter;
        ...
        public MainForm()
        {
            ...
            _generationSetter = new GenerationSetter();
        }
        ...
        {
            _generationSetter.Randomize(_currentGeneration);
        ...
        {
            _generationSetter.Clear(_currentGeneration);
